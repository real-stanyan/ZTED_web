...
export default function Culture() {
  ...
  const [opacity, setOpacity] = useState("opacity-0"); // 默认为隐藏状态
  ...
  return (
    <div className="min-w-full text-black md:bg-aboutus-title bg-no-repeat bg-fixed bg-left bg-[length:300px_600px]">
      <div
        className={` fixed text-[2vw] text-white left-[10px] top-[45vh] transition-all duration-500 ease-in-out ${opacity}`}
      >
        {shown}
      </div>
      {/* 河南地理位置 */}
      <div
        ...
        title="河南地理位置"
      >
        <h1 className="text-[6vw] md:text-[2.5vw] my-[2vw] ml-[-1vw]">
          河南地理位置
        </h1>
